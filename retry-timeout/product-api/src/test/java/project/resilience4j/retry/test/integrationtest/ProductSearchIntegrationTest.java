package project.resilience4j.retry.test.integrationtest;
...
class ProductSearchIntegrationTest {
    ...
    void product_search_test(Long parameter) {
        Product findProduct = productSearchService.findProductById(parameter);
    ...
    void product_search_failure_test(Long parameter) {
        assertThatThrownBy(()->productSearchService.findProductById(parameter))
